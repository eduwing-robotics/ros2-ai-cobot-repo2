...
async function refresh() {
    ...
    try {
        ...
        /*
         * Clear only a stale status-fetch error after
         * /status communication has recovered.
         * Other operator messages are preserved.
         */
        const msgEl =
...
<!-- FACTORY VIEW CLEAN FINAL -->
<section
    id="factoryViewSection"
    style="
        width:min(1980px, calc(100% - 20px));
    ...
    "
>
    <!-- HEADER: same hierarchy as PRE-ROOF -->
    <div
        style="
            width:100%;
            box-sizing:border-box;
    ...
    >
        <div>
            ...
            <div
                ...
                "
            >
                Logitech C270 · 1280 × 960 · Monitoring Only
            </div>
        </div>
    ...
    <!--
        OUTER BOX = PRE-ROOF WIDTH
        VIDEO = FIXED MAX 1280px
    -->
    <div
        style="
            width:100%;
    ...
    <div
        ...
        "
    >
        FACTORY VIEW는 전체 공정 모니터링 전용이며
        PRE-ROOF 검사 판정에는 사용되지 않습니다.
    </div>
</section>
...
<style>
/* =========================================================
   FACTORY_UNDER_LIVE_PANEL_FINAL

   FACTORY VIDEO / C270 / FILTER : NO CHANGE
   PRE-ROOF LIVE PANEL           : NO CHANGE
   INSPECTOR                     : NO CHANGE

   Layout only:
   Factory View is placed directly below the
   PRE-ROOF live inspection panel at identical width.
   ========================================================= */
...
#liveFactoryStack > #factoryViewSection {
    grid-column: 1;
    grid-row: 2;
...
(function () {
    ...
    function mountFactoryUnderLivePanel() {
...
# =========================================================
# FACTORY VIEW MONITOR V1
# Monitoring only - not part of PRE_ROOF decision logic
# =========================================================

FACTORY_TOPIC = "/vision/factory_camera/image_view"
...
class FactoryViewSubscriber(Node):

    def __init__(self):

        super().__init__(
            "harmony_dashboard_factory_view"
        )
        ...
        self.get_logger().info(
            f"FACTORY VIEW subscribed: {FACTORY_TOPIC}"
        )
    ...
    def on_image(self, msg):
        ...
        try:
            ...
            with FACTORY_LOCK:
                FACTORY_JPEG = jpg.tobytes()
                FACTORY_SEQ += 1
                FACTORY_LAST_RX = time.time()
...
def factory_status():
    ...
    with FACTORY_LOCK:
        seq = FACTORY_SEQ
        last = FACTORY_LAST_RX
        ready = FACTORY_JPEG is not None
...
FACTORY_NODE = FactoryViewSubscriber()
...
print(
    f"FACTORY VIEW : "
    f"http://127.0.0.1:{PORT}/factory.mjpg"
)

print(
    f"FACTORY TOPIC: {FACTORY_TOPIC}"
)
